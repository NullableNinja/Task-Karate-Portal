...
export type Template = { id: string; name: string; dayOfWeek: string; startTime: string; durationMinutes: number; beltScope?: string; classType?: string; appointmentOnly?: boolean };
